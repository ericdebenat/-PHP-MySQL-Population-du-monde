...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 28 fév. 2019 à 11:15
...
INSERT INTO `t_pays` (`id_pays`, `libelle_pays`, `population_pays`, `taux_natalite_pays`, `taux_mortalite_pays`, `esperance_vie_pays`, `taux_mortalite_infantile_pays`, `nombre_enfants_par_femme_pays`, `taux_croissance_pays`, `population_plus_65_pays`, `continent_id`, `region_id`) VALUES
...
--
ALTER TABLE `t_pays`
  MODIFY `id_pays` smallint(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=405;
